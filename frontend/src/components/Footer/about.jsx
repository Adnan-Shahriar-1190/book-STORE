...
const About = () => {
  return (
    <div className='max-w-4xl mx-auto p-6'>
      ...
      <p className='text-black mb-4'>
        Founded in 2024, BookStore is under development. Our passion for helping people find the best books drove us to turn hard work and inspiration into a booming online store. We now serve customers all over the world and are thrilled to be a part of the eco-friendly wing of the book industry.
      </p>
      <p className='text-black mb-4'>
