    ...
    <>
      ...
      >
        {links.map((items, i) => (
          <Link
            to={items.link}
            className={`${MobileNav}  text-white text-4xl font-semibold mb-8 hover:text-red-500 transition-all duration-300`}
            key={i}
            onClick={() =>
              MobileNav === "hidden"
                ? setMobileNav("block")
        ...
        <Link
          to="/LogIn"
          className={`${MobileNav} px-4 py-2 mb-4 text-2xl border border-blue-500  rounded hover:bg-white hover:text-zinc-800 transition-all duration-300`}
        >
          LogIn
        </Link>
        <Link
          to="/SignUp"
          className={`${MobileNav} px-4 py-2 mb-4 text-2xl bg-blue-500 text-zinc-800 rounded  hover:bg-white hover:text-zinc-800 transition-all duration-300`}
        >
          SignUp
        </Link>
      </div>
